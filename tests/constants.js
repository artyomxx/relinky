...
export const pathSetupStatus = '/api/setup/status'
export const pathSetup = '/api/setup'
export const pathAuthPassword = '/api/auth/password'
export const pathAuthPasswordSource = '/api/auth/password-source'
...
export const pathDefaults = '/api/domains/defaults'
export const pathApiKeys = '/api/api-keys'
